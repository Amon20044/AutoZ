...
export const PART_TAXONOMY = Object.freeze([
  ...
  // ─── Wheels ──────────────────────────────────────────────────
  {
    ...
    category: 'wheel',
    exactTokens: ['wheel', 'tire', 'tyre', 'wheel_fl', 'wheel_lf', 'wheel_front_left', 'front_left_wheel', 'left_front_wheel', 'front_wheel_left', 'wheel_left_front', 'tire_fl', 'tire_lf', 'tyre_fl', 'tyre_lf', 'rad_vl', 'roue_avg', 'w_fl', 'w_lf'],
    regexPatterns: [
      /\bwheel[_.\s-]?f[_.\s-]?l(?:\b|[_.\s-])/i, /\bwheel[_.\s-]?l[_.\s-]?f(?:\b|[_.\s-])/i,
      /\bf[_.\s-]?l[_.\s-]?wheel(?:\b|[_.\s-])/i, /\bl[_.\s-]?f[_.\s-]?wheel(?:\b|[_.\s-])/i,
      /\b(front[_.\s-]?left|left[_.\s-]?front)[_.\s-]?wheel/i, /\bwheel[_.\s-]?(front[_.\s-]?left|left[_.\s-]?front)/i,
      /\bt[iy]re[_.\s-]?(f[_.\s-]?l|l[_.\s-]?f)(?:\b|[_.\s-])/i,
    ],
  ...
  },
  {
    ...
    category: 'wheel',
    exactTokens: ['wheel_fr', 'wheel_rf', 'wheel_front_right', 'front_right_wheel', 'right_front_wheel', 'front_wheel_right', 'wheel_right_front', 'tire_fr', 'tire_rf', 'tyre_fr', 'tyre_rf', 'rad_vr', 'roue_avd', 'w_fr', 'w_rf'],
    regexPatterns: [
      /\bwheel[_.\s-]?f[_.\s-]?r(?:\b|[_.\s-])/i, /\bwheel[_.\s-]?r[_.\s-]?f(?:\b|[_.\s-])/i,
      /\bf[_.\s-]?r[_.\s-]?wheel(?:\b|[_.\s-])/i, /\br[_.\s-]?f[_.\s-]?wheel(?:\b|[_.\s-])/i,
      /\b(front[_.\s-]?right|right[_.\s-]?front)[_.\s-]?wheel/i, /\bwheel[_.\s-]?(front[_.\s-]?right|right[_.\s-]?front)/i,
      /\bt[iy]re[_.\s-]?(f[_.\s-]?r|r[_.\s-]?f)(?:\b|[_.\s-])/i,
    ],
  ...
  },
  {
    ...
    category: 'wheel',
    exactTokens: ['wheel_rl', 'wheel_lr', 'wheel_rear_left', 'rear_left_wheel', 'left_rear_wheel', 'rear_wheel_left', 'wheel_left_rear', 'tire_rl', 'tire_lr', 'tyre_rl', 'tyre_lr', 'rad_hl', 'roue_arg', 'w_rl', 'w_lr'],
    regexPatterns: [
      /\bwheel[_.\s-]?r[_.\s-]?l(?:\b|[_.\s-])/i, /\bwheel[_.\s-]?l[_.\s-]?r(?:\b|[_.\s-])/i,
      /\br[_.\s-]?l[_.\s-]?wheel(?:\b|[_.\s-])/i, /\bl[_.\s-]?r[_.\s-]?wheel(?:\b|[_.\s-])/i,
      /\b(rear|back)[_.\s-]?left[_.\s-]?wheel/i, /\bleft[_.\s-]?(rear|back)[_.\s-]?wheel/i, /\bwheel[_.\s-]?((rear|back)[_.\s-]?left|left[_.\s-]?(rear|back))/i,
      /\bt[iy]re[_.\s-]?(r[_.\s-]?l|l[_.\s-]?r)(?:\b|[_.\s-])/i,
    ],
  ...
  },
  {
    ...
    category: 'wheel',
    exactTokens: ['wheel_rr', 'wheel_rear_right', 'rear_right_wheel', 'right_rear_wheel', 'rear_wheel_right', 'wheel_right_rear', 'tire_rr', 'tyre_rr', 'rad_hr', 'roue_ard', 'w_rr'],
    regexPatterns: [
      /\bwheel[_.\s-]?r[_.\s-]?r(?:\b|[_.\s-])/i, /\br[_.\s-]?r[_.\s-]?wheel(?:\b|[_.\s-])/i,
      /\b(rear|back)[_.\s-]?right[_.\s-]?wheel/i, /\bright[_.\s-]?(rear|back)[_.\s-]?wheel/i, /\bwheel[_.\s-]?((rear|back)[_.\s-]?right|right[_.\s-]?(rear|back))/i,
      /\bt[iy]re[_.\s-]?r[_.\s-]?r(?:\b|[_.\s-])/i,
    ],
  ...
  // ─── Rims ────────────────────────────────────────────────────
  {
    ...
    category: 'rim',
    exactTokens: ['rim', 'alloy', 'hubcap', 'rim_fl', 'rim_lf', 'rim_front_left', 'front_left_rim', 'alloy_fl', 'alloy_lf', 'hubcap_fl', 'hubcap_lf', 'felge_vl'],
    regexPatterns: [/\b(rim|alloy|hubcap)[_.\s-]?(f[_.\s-]?l|l[_.\s-]?f)(?:\b|[_.\s-])/i, /\b(front[_.\s-]?left|left[_.\s-]?front)[_.\s-]?(rim|alloy|hubcap)/i],
  ...
  {
    typeKey: 'rim.front.right',
    label: 'Front Right Rim',
    category: 'rim',
    exactTokens: ['rim_fr', 'rim_rf', 'rim_front_right', 'front_right_rim', 'alloy_fr', 'alloy_rf', 'hubcap_fr', 'hubcap_rf', 'felge_vr'],
    regexPatterns: [/\b(rim|alloy|hubcap)[_.\s-]?(f[_.\s-]?r|r[_.\s-]?f)(?:\b|[_.\s-])/i, /\b(front[_.\s-]?right|right[_.\s-]?front)[_.\s-]?(rim|alloy|hubcap)/i],
    fuzzyTokens: ['rim', 'hub', 'alloy', 'front', 'right'],
    defaultInteraction: 'spin',
    defaultAxis: [1, 0, 0],
    defaultOpenAngle: 0,
    weight: 1.0,
  ...
  {
    typeKey: 'rim.rear.left',
    label: 'Rear Left Rim',
    category: 'rim',
    exactTokens: ['rim_rl', 'rim_lr', 'rim_rear_left', 'rear_left_rim', 'alloy_rl', 'alloy_lr', 'hubcap_rl', 'hubcap_lr', 'felge_hl'],
    regexPatterns: [/\b(rim|alloy|hubcap)[_.\s-]?(r[_.\s-]?l|l[_.\s-]?r)(?:\b|[_.\s-])/i, /\b((rear|back)[_.\s-]?left|left[_.\s-]?(rear|back))[_.\s-]?(rim|alloy|hubcap)/i],
    fuzzyTokens: ['rim', 'hub', 'alloy', 'rear', 'left'],
    defaultInteraction: 'spin',
    defaultAxis: [1, 0, 0],
    defaultOpenAngle: 0,
    weight: 1.0,
  ...
  {
    typeKey: 'rim.rear.right',
    label: 'Rear Right Rim',
    category: 'rim',
    exactTokens: ['rim_rr', 'rim_rear_right', 'rear_right_rim', 'alloy_rr', 'hubcap_rr', 'felge_hr'],
    regexPatterns: [/\b(rim|alloy|hubcap)[_.\s-]?r[_.\s-]?r(?:\b|[_.\s-])/i, /\b((rear|back)[_.\s-]?right|right[_.\s-]?(rear|back))[_.\s-]?(rim|alloy|hubcap)/i],
    fuzzyTokens: ['rim', 'hub', 'alloy', 'rear', 'right'],
    defaultInteraction: 'spin',
    defaultAxis: [1, 0, 0],
    defaultOpenAngle: 0,
    weight: 1.0,
